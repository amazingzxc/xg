...
parser.add_argument('--img_size', dest='img_size', type=int, default=64, help='# the size of the input image')
parser.add_argument('--ngf', dest='gf_dim', type=int, default=8, help='# of gen filters in first conv layer')
parser.add_argument('--ndf', dest='df_dim', type=int, default=8, help='# of discri filters in first conv layer')
